...
import com.myapps.simpleweatherapp.databinding.FragmentDetectLocationBinding
...
class DetectLocationFragment : Fragment() {
    ...
    private fun initAlertsDialogPermission() {
        ...
        builder.setPositiveButton(getString(R.string.receive)) { _, _ -> navigate(true) }
        builder.setNegativeButton(getString(R.string.disable)) { _, _ -> navigate(false) }
        builder.setNeutralButton(getString(R.string.cancel)) { _, _ -> viewModel.hideDialog() }
