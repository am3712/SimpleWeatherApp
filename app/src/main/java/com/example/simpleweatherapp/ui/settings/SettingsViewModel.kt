package com.example.simpleweatherapp.ui.settings
...
import com.example.simpleweatherapp.data.repository.LocationOptions
...
import com.example.simpleweatherapp.ui.alarms.getCorrectStart
import com.example.simpleweatherapp.utils.*
...
suspend fun updateAlarm(repository: Repository, alarm: Alarm, active: Boolean) {
    repository.addAlarm(
        Alarm(
